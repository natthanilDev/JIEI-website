import '../../../en/component/footer/footer.css'
    ...
    return (
        <footer>
            <div className="container-footer">
                ...
                <div className="about-us-footer">
                    ...
                    <ul className='about-list'>
                        ...
                        <li><Link target='_blank' href={'https://maps.app.goo.gl/cE3RtxecAna7pTtx9'} ><span><HomeFilled /></span> タイ王国 〒20230
                            チョンブリー県シラチャー郡ブン町ムー6、180/3
                            ピントン4工業団地 G18ユニット </Link></li>
                        <li><Link href={'/'} ><span><BookFilled /></span> 納税者番号（TIN）：0215554005118 </Link></li>
                    </ul>
                </div>
            ...
            <div className="not-copy-page">
                <p>Copyright © 2025 JIEI（THAILAND）CO., LTD. 無断複製・転載を禁じます。</p>
            </div>
        </footer>
    )
}
